                            ...
                            <form className="uk-form-horizontal uk-margin-large">
                              ...
                              <div className="uk-margin">
                                ...
                                <div className="uk-form-controls uk-form-controls-text">
                                  <label><input className="uk-radio" type="radio" name="radio1" /> Beginner</label><br />
                                  <label><input className="uk-radio" type="radio" name="radio1" /> Intermediate</label><br />
                                  <label><input className="uk-radio" type="radio" name="radio1" /> Advanced</label><br />
